...
<?php
    ...
    if (!empty($_GET['code']) && !empty($_GET['weekNumber'])) {
        ...
        $ret = dataService_interface("INFO ACTIVITY TABLE", $code);
...
<body>
    ...
    <div class="container">
    <a href="page1.php"><img id="icon-back" src="../resources/images/back.png"></a>
        ...
        <div>
            ...
            <div class="row" style="padding-top: 10px">
                ...
                <?php dataService_interface("EDIT NOTE", $code);?>
                ...
                <div class="col-sm-4 row3">
                    <ul style="padding-left: 10px;">
                        ...
                        <?php dataService_interface("SKILLS NEEDED", $code);?>
                    </ul>
                </div>
            </div>
            <!--RIGA 4-->
